...
- (void)showSetupWindow {
    NSLog(@"🔧 VaultSetupController: Starting setup window...");
    [self loadWindow];
    NSLog(@"🪟 VaultSetupController: Window loaded");
    [self.window makeKeyAndOrderFront:nil];
    NSLog(@"🎯 VaultSetupController: Window shown, running modal...");
    [NSApp runModalForWindow:self.window];
    NSLog(@"✅ VaultSetupController: Modal finished");
}
