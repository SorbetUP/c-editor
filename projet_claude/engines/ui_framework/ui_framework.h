...
typedef enum {
    ...
    UI_ICON_TOOLS = 4,      // 🔧 Outils - maintenance et aide (utilitaires)
    UI_ICON_SETTINGS = 5,   // ⚙️ Roue crantée - paramètres (configuration)
    UI_ICON_BACK = 6        // ⬅️ Flèche - retour/navigation
} UIIconType;
