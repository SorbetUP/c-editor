...
int json_find_key(const char *json, const JsonToken *tokens, const JsonToken *parent, const char *key);
...
RGBA json_parse_rgba_array(const char *json, const JsonToken *tokens, const JsonToken *array_token);
