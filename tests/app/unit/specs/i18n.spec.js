describe('renderer i18n language loading', () => {
  ...
  it('does not reload the default English locale', async() => {
    const { setLanguage, getCurrentLanguage } = await import('../../../../Elephant/frontend/src/renderer/src/i18n')
  ...
  it('loads an unavailable locale only once', async() => {
    const { setLanguage } = await import('../../../../Elephant/frontend/src/renderer/src/i18n')
