...
void test_image_with_attributes(void) {
  ...
  const char *markdown =
      "![alt](https://x/img.png){w=160 h=120 a=0.9 align=right}";
...
void test_inline_loop_regression(void) {
  ...
  const char *test_cases[] = {
      "Hello World", "Text with *unclosed italic", "Text with **unclosed bold",
      "Text with ==unclosed highlight", "Text with ++unclosed underline"};
