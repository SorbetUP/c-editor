...
// Fonctions de callback C pour l'interface UI
...
@interface ElephantNotesV3Controller : NSObject <VaultCreationDelegate, NSOutlineViewDataSource, NSOutlineViewDelegate, NSTableViewDataSource, NSTableViewDelegate> {
    ...
    // Interface de recherche visuelle
    NSView* _searchView;
    NSTextField* _searchField;
    NSOutlineView* _fileTreeView;
    NSScrollView* _treeScrollView;
    NSTreeController* _treeController;
    NSMutableArray* _fileTreeData;
    bool _searchViewVisible;
    
    // Interface de recherche moderne
    NSTableView* _searchTableView;
    NSMutableArray* _searchFileList;
    NSMutableArray* _filteredFileList;
